...
Dist1 = (SNFtool::dist2(as.matrix(Data1),as.matrix(Data1)))^(1/2)
Dist2 = (SNFtool::dist2(as.matrix(Data2),as.matrix(Data2)))^(1/2)
...
M_label_colors=cbind("spectralClustering"=getColorsForGroups(M_label[,"spectralClustering"],
                                                             colors=rainbow(C)),
                     "TrueLabel"=getColorsForGroups(M_label[,"TrueLabel"],colors=c("blue","green")))
